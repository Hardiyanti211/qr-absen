                ...
                <div class="card-body">
                    ...
                    <form class="row g-3" method="POST" action="{{ route('setting.update', $setting->id_setting) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" name="masuk_setting" class="form-control" value="{{ $setting->masuk_setting }}">    
                        </div>  
                        <div class="col-md-6 mb-3">
                            <label for="">Jam Pulang</label>
                            <input type="time" name="pulang_setting" class="form-control" value="{{ $setting->pulang_setting }}">    
                        </div>  
                        <div class="col-12 mb-3">
